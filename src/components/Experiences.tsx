  ...
  const cards = [
    {
      ...
      title: 'VESSEL & CREW',
      description: 'Custom itineraries across Mediterranean to Pacific with dedicated crew.'
    },
    {
      category: 'RACING PROGRAM',
      title: 'OFFSHORE & INSHORE',
      description: 'Join our competitive racing calendar with professional instruction.'
    },
    {
      category: 'CONCIERGE',
      title: '24 / 7 ACCESS',
      description: 'Every detail handled — provisioning, berthing, customs, and beyond.'
    }
  ];
